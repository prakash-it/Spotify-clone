...
export default function Sidebar() {
  return (
    <div className='bg-[#003A10] min-h-screen pl-[4vw]'>
     ...
     <img src={assets.logo_small} className="mt-5 w-[max(5vw,40px)] mr-5 sm:hidden block" alt="logo" />
     ...
     <NavLink to='/add-albums' className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium">
