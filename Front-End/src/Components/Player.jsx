...
export default function Player() {
 ...
 const{seekBar,seekkBg,seeksong,track,playStatus,play,pause,time,next, previous} = useContext(Playercontext)
    ...
    <div className='flex flex-col items-center gap-1 m-auto'>
     ...
     : <img  onClick={play}  src={assets.play_icon} alt="" className='w-4 cursor-pointer' />
      ...
      <div className='flex items-center gap-5 '>
        ...
        <div ref={seekkBg} onClick={seeksong} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
